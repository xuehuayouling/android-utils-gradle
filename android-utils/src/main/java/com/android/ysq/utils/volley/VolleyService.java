...
final public class VolleyService {
	...
	/**
	 * 调用
	 * {@link #requestObject(int, String, String, Map, VolleyServiceCallBack, Class, boolean)}
	...
	/**
	 * 调用
	 * {@link #requestObject(String, String, Map, VolleyServiceCallBack, Class)}
	 * ，其中最后一个参数为null
	 * 
	 * @param requestKey
	 *            请求关键字
	 ...
	 *            请求结果回调方法
	 * @param clazz
	 *            请求返回数据的结果类型，可以重写{@link IResponseDTO#isSuccess()}
	 *            ，返回成功时若此参数不为空则返回{@link IResponseDTO#getSuccessResult()}, 若为空则返回
	 *            {@link IResponseDTO}
	 * @param cancelSame
